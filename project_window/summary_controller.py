...
#        final_prompt = self.model.build_final_prompt(prompt, plain_text)
    ...
    def _on_summary_complete(self):
        ...
        self.status_updated.emit("Summary generated successfully.")

    def _show_warning(self, message):
        QMessageBox.warning(self.view, "Summary", message)

    def _show_error(self, message):
        QMessageBox.critical(self.view, "Summary Error", message)
